...
const fineDining: IResourceInfo[] = [
  {
    ...
    acknowledgement: "Tasting Table. (n.d.). Seafood Restaurant [Photograph]. Tasting Table. https://www.tastingtable.com/img/gallery/the-best-seafood-restaurants-in-america/intro-1647440546.webp"
  },
  {
    title:"Taste of Home",
    ...
    acknowledgement: "Bayut. (n.d.). American Restaurant [Photograph]. Bayut. https://mybayutcdn.bayut.com/mybayut/wp-content/uploads/American-Restaurants-in-Dubai-Cover-24-05-1170x508.jpg"
  },
  {
    ...
    acknowledgement: "Uber Eats. (n.d.). Pan-Asian Cuisine [Photograph]. Uber Eats. https://tb-static.uber.com/prod/image-proc/processed_images/e26dbe0c7ddbc4fb41b5877598d0ba38/c73ecc27d2a9eaa735b1ee95304ba588.jpeg"
  },
]
...
const localProvisions: IResourceInfo[] = [
  {
    ...
    acknowledgement: "Vox. (2023). Interior of Supermarket [Photograph]. Vox. https://cdn.vox-cdn.com/thumbor/uxEjCY-m_e7IWRy0uBGT0f-GTwE=/0x0:1024x576/1220x813/filters:focal(431x207:593x369):format(webp)/cdn.vox-cdn.com/uploads/chorus_image/image/72594824/IP_Union_City.0.jpeg"
  },
  {
    ...
    acknowledgement: "Guide to San Juans. (2016). Village Market [Photograph]. Guide to San Juans. https://www.guidetosanjuans.com/wp-content/uploads/2016/02/villagemarket.jpg"
  },
  {
    ...
    acknowledgement: "CityFeet. (n.d.). 24-Hour Convenience Store [Photograph]. CityFeet. https://images1.cityfeet.com/i2/wXDEX7JfG7JQzg0s14xWLDvkrqCba-rGSBTMExJkMZI/110/1212-victory-blvd-staten-island-photo-1-of-11.jpg"
  },
]