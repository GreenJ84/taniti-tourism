...
const lodging: IResourceInfo[] = [
  {
    ...
    acknowledgement: "The Luxury Travel Expert. (n.d.). Calala Island, Nicaragua [Photograph]. The Luxury Travel Expert. https://i0.wp.com/theluxurytravelexpert.com/wp-content/uploads/2018/02/CALALA-ISLAND-NICARAGUA.jpg?ssl=1"
  },
  {
    title: "Hotels",
    ...
    acknowledgement: "Montage Hotels & Resorts. (n.d.). Montage Deer Valley [Photograph]. Montage Hotels & Resorts. https://phgcdn.com/images/uploads/MCDIH/masthead/hero3.jpg"
  },
  {
    title: "Hostels",
    ...
    acknowledgement: "Island Life Backpackers. (n.d.). Island Life Backpackers Hostel [Photograph]. TripAdvisor. https://dynamic-media-cdn.tripadvisor.com/media/photo-o/0e/bc/36/32/island-life-backpackers.jpg?w=2000&h=-1&s=1"
  },
  {
    ...
    acknowledgement: "Forrer, S. (n.d.). Otters Pond B&B on Orcas Island [Photograph]. San Juan Islands. https://sanjuan.objects.liquidweb.services/photos/137-otters-pond-bb-on-orcas-island-by-stephanie-forrer-1-2800x900-2000.webp"
  },
];